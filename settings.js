...
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=nNlTnRDB#xNUKycwUn2mVpsTfoLb09NblyTFr_1eJF2aIhKhzPA4' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '94784846706' : process.env.OWNER_NUMBER,   
